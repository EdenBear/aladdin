...
<block name='body'>
    <button class="btn btn-sm btn-primary">拼团列表</button>
    <a href='{:U("edit")}' target="_blank" class="btn btn-sm btn-primary">新增拼团</a>
    <a href='{:U("index_open")}' target="_blank" class="btn btn-sm btn-primary">新增拼团</a>
