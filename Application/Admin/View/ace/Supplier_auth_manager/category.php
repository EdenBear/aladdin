...
<div class="tabbable">
    <ul class="nav nav-tabs padding-18">
        <li><a href="{:U('SupplierAuthManager/access',array('group_name'=>I('group_name') ,'group_id'=> I('group_id')))}">访问授权</a></li>
        <li class="active"><a href="javascript:;">分类授权</a></li>
        <li><a href="{:U('SupplierAuthManager/user',array('group_name'=>I('group_name') ,'group_id'=> I('group_id')))}">成员授权</a></li>
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-info">
                <volist name="auth_group" id="vo">
	                <li <eq name="vo['id']" value="$this_group['id']">class="active"</eq>>
	                    <a data-toggle="tab" href="{:U('SupplierAuthManager/access',array('group_id'=>$vo['id'],'group_name'=>$vo['title']))}">{$vo.title}</a>
	                </li>
                </volist>
            </ul>
        </li>
    ...
    <div class="tab-content no-border padding-24">
        ...
        <div class="tab-pane active">
            <form class="save-category" action="{:U('SupplierAuthManager/addToCategory')}" method="post" enctype="application/x-www-form-urlencoded">
                ...
                <div class="category auth-category">
                    ...
                    {:R('SupplierAuthManager/tree', array($group_list))}
                </div>
