...
<div class="tabbable">
    <ul class="nav nav-tabs padding-18">
        ...
        <li><a href="{:U('SupplierAuthManager/category',array('group_name'=>I('group_name') ,'group_id'=> I('group_id')))}">分类授权</a></li>
    ...
    <div class="tab-content no-border padding-24">
        ...
        <div class="tab-pane active">
			<form action="{:U('SupplierAuthManager/writeGroup')}" enctype="application/x-www-form-urlencoded" method="POST" class="form-horizontal auth-form">
