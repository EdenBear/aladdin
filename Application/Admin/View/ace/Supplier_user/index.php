			    ...
			    <tbody>
					...
					<tr>
						...
						<td>
                            ...
                            $url = U('SupplierUser/changeStatus?method=resumeUser&id='.$vo['id']);
                            if($vo['status'] == '1'){
                                $url = U('SupplierUser/changeStatus?method=forbidUser&id='.$vo['id']);
                            }
                            ?>
                            <label>
                        ...
                        <td>
                            <a title="授权" href="{:U('SupplierAuthManager/group?uid='.$vo['id'])}" class="">
                                授权
                            </a>
                            <a title="删除" href="{:U('SupplierUser/changeStatus?method=deleteUser&id='.$vo['id'])}" class="confirm ajax-get">
                                删除
                            </a>
                        </td>
					</tr>
