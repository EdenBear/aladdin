...
<block name="body">
     <div class="table-responsive">
        <div class="dataTables_wrapper">  
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?=U('SupplierUser/paasusers')?>" method="POST" class="search-form">
                        <label>昵称
                        ...
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" id="search-btn" url="{:U('SupplierUser/paasusers')}">
