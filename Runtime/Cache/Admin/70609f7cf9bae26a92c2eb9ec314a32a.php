	...
	<form id="form" action="<?php echo U('saveAction');?>" method="post" class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="text" class="width-100" name="name" value="<?php echo ($data["name"]); ?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="text" class="width-100" name="title" value="<?php echo ($data["title"]); ?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<textarea name="remark" class="autosize-transition span12 form-control"><?php echo ($data["remark"]); ?></textarea>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<textarea name="rule" class="autosize-transition span12 form-control"><?php echo ($data["rule"]); ?></textarea>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<textarea name="log" class="autosize-transition span12 form-control"><?php echo ($data["log"]); ?></textarea>
			</div>
