        ...
        <div class="dataTables_wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form class="search-form">
                        <label>公司全称
                            <input type="text" class="search-input" name="company_name" value="<?php echo I('company_name');?>" placeholder="请输入公司简称">
                        </label>
                        <label>用户姓名
                            <input type="text" class="search-input" name="real_name" value="<?php echo I('real_name');?>" placeholder="请输入账户昵称">
                        </label>
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" id="search-btn" url="<?php echo U('verify');?>">
            ...
            <table class="table table-striped table-bordered table-hover dataTable">
                ...
                <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a title="审核" href="<?php echo U('verifyshow?id='.$item['id']);?>">审核</a>
                            </td>
