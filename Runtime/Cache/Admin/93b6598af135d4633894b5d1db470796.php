     ...
     <div class="table-responsive">
        <div class="dataTables_wrapper">  
            ...
            <div class="row">
                <div class="col-sm-4">
                    <label>
                        <a class="btn btn-white" href="<?php echo U('createGroup');?>">
                            新增
                        </a>
                    </label>
                    <label>
                        <button class="btn btn-white ajax-post" target-form="ids" url="<?php echo U('changestatus?method=resumeGroup');?>">
                            启 用
                        </button>
                    </label>
                    <label>
                        <button class="btn btn-white ajax-post" target-form="ids" url="<?php echo U('changestatus?method=forbidGroup');?>">
                            暂停
                        </button>
                    </label>
                    <label>
                        <button class="btn btn-white ajax-post" target-form="ids" url="<?php echo U('changestatus?method=deleteGroup');?>">
                            删除
                        </button>
                    </label>
                </div>
