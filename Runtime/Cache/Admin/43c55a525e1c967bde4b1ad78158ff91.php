...
<html lang="cn">
	...
	<div class="page-header">
		<h1>
			...
			<form action="<?php echo U('category/operate',array('type'=>$type));?>" method="post" class="form-horizontal">
				<div class="form-group">
					...
					<span class="help-block col-xs-12 col-sm-reset inline">（将<?php echo ($operate); ?>至的分类）</span>
				</div>
