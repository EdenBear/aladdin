...
<html lang="cn">
    ...
    <div class="table-responsive">
        <div class="dataTables_wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <form method="get" action="/admin.php?s=/factory/tasklist.html" class="search-form">
                        <label>状态:
                            <?php
 echo form_dropdown('status',array_values($status_list),I('status')); ?>
                        </label>
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" id="search-btn" url="<?php echo U('factory/tasklist');?>">
            ...
            <table class="table table-striped table-bordered table-hover dataTable">
                ...
                <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo['amount']/10000); ?></td>
                            <td><?php echo ($status_list[$vo['status']]); ?></td>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <label>
                        <a class="btn btn-white" href="<?php echo U('addTask');?>">
                            新增
                        </a>
                    </label>
                </div>
