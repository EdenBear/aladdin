 ...
 <div class="table-responsive">
    <div class="dataTables_wrapper">  
        ...
        <table class="table table-striped table-bordered table-hover dataTable">
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?><tr>
						<td class="center">
                            <label>
                                <input class="ace ids" type="checkbox" name="id[]" value="<?php echo ($channel['id']); ?>" />
                                <span class="lbl"></span>
                            </label>
                        </td>
        ...
        <div class="row">
            <div class="col-sm-12">
                <label>
                    <a class="btn btn-white" href="<?php echo U('add','pid='.$pid);?>">
                        新增
                    </a>
                </label>
                <label>
                    <a class="btn btn-white list_sort" href="<?php echo U('sort',array('pid'=>I('get.pid',0)),'');?>">
                        排序
                    </a>
                </label>
            </div>
