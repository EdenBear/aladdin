    ...
    <form action="<?php echo U('AuthManager/writeGroup');?>" enctype="application/x-www-form-urlencoded" method="POST"
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-5">
                <input id="auth-title" type="text" name="title" class="width-100" value="<?php echo ($auth_group["title"]); ?>"/>
            </div>
        </div>
        <div class="form-group">
            <label for="auth-description" class="col-xs-12 col-sm-2 control-label no-padding-right">描述</label>
            <div class="col-xs-12 col-sm-5">
                <textarea id="auth-description" name="description" class="autosize-transition span12 form-control"><?php echo ($auth_group["description"]); ?></textarea>
            </div>
        </div>
