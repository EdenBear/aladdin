            ...
            <div class="row">
                <div class="col-sm-12">
                    <form class="search-form">
                        <label>用户名
                            <input type="text" class="search-input" name="nick_name" value="<?php echo I('nick_name');?>" placeholder="请输入用户名">
                        </label>
                        <label>账户名ID
                            <input type="text" class="search-input" name="account_id" value="<?php echo I('account_id');?>" placeholder="请输入账户ID">
                        </label>
                        <label>状态
<select name="status">
...
<label>
            ...
            <table class="table table-striped table-bordered table-hover dataTable">
				...
				<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo (price_format($item["frozen_sum"])); ?></td>
                        <td><?php echo $status[$item['status']];?></td>
                        <td><?php echo ($item["remark"]); ?></td>
                        <td>
                            <a title="查看交易明细" href="<?php echo U('showitem?id='.$item['account_id']);?>">查看交易明细</a>
                        </td>
