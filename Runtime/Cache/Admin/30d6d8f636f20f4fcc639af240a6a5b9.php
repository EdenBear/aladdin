...
<html lang="cn">
    ...
    <link rel="stylesheet" href="/Public/Ace/css/chosen.css" />
 ...
 foreach($plist as $val): ?>
                    <option <?php if(array_key_exists($val['id'],$selected)) echo 'disabled'?> value="<?=$val['id']?>"><?=$val['mobile_num']?>/<?=$val['company_name']?></option>
                <?php
 endforeach; ?>
            </select>
        </div>
    ...
    <?php
 echo ace_form_open('biddermanage/brsort'); ?>
    <div class="form-group rule-wrap">
        <div class="col-sm-12">

            <div class="controls sort">
                <form action="<?php echo U('zbsort');?>" method="post">
                    <div class="sort_center">
                        <div class="sort_option">
                            <select name="selected[]" multiple="multiple" id="select-right" class="width-100">
                                <?php if(is_array($selected)): foreach($selected as $key=>$vo): ?><option class="ids" title="<?=$vo['id']?>/<?php echo ($vo["company_name"]); ?>" value="<?php echo ($vo["id"]); ?>"><?=$vo['mobile_num']?>/<?php echo ($vo["company_name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
 ...
 echo ace_srbtn(); echo ace_form_close() ?>
    ...
    <script src="/Public/Ace/js/chosen.jquery.min.js"></script>
	<script type="text/javascript">
