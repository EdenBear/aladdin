...
<html lang="cn">
    ...
    <div class="page-header">
        <h1>
            <small>
                <i class="icon-double-angle-right"></i>
                <?php if(isset($_GET['group'])): ?><a href="<?php echo U('index');?>">全部</a><?php else: ?><strong>全部</strong><?php endif; ?>&nbsp;<?php if(is_array($group)): foreach($group as $key=>$vo): if(($group_id) != $key): ?><a href="<?php echo U('index?group='.$key);?>"><?php echo ($vo); ?></a><?php else: ?><strong><?php echo ($vo); ?></strong><?php endif; ?>&nbsp;<?php endforeach; endif; ?>
            </small>
        </h1>
    </div>
        ...
        <div class="dataTables_wrapper">  
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="search-form">
                        ...
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" id="search" url="<?php echo U('config/index');?>">
            ...
            <table class="table table-striped table-bordered table-hover dataTable">
				...
				<tbody>
					<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$config): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a title="删除" href="<?php echo U('del?id='.$config['id']);?>" class="ui-pg-div ui-inline confirm ajax-get">
                                    删除
                                </a>
                            </td>
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <label>
                        <a class="btn list_sort btn-white" href="<?php echo U('sort?group='.I('group'),'','');?>">
                            排序
                        </a>
                    </label>
                </div>
