	    ...
	    <div class="dataTables_wrapper">   
	        <div class="row">
	            <div class="col-sm-12 col-xs-12">
	                <form method="get" action="/admin.php?s=/factory/accountlist.html" class="search-form">
                        <label>账号
                            <input type="text" class="search-input" name="accountId" value="<?php echo I('accountId');?>">
                        </label>
	                    <label>类型
                            <?php  echo form_dropdown('accountType',array_values($accountTypeList),I('accountType')); ?>
                        </label>
	                    <label>状态
                            <?php  echo form_dropdown('status',array_values($status_list),I('status'));s ?>
                        </label>
	                    <label>
	                        <button class="btn btn-sm btn-primary" type="button" id="search-btn" url="<?php echo U('/factory/accountlist');?>">
	        ...
	        <table class="table table-striped table-bordered table-hover dataTable">
	           ...
	           <tbody id="tbody_content">
				    <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	                        <td class="center">
	                            <label>
	                                <input class="ace ids" type="checkbox" name="id[]" value="<?php echo ($vo["accountid"]); ?>" />
	                                <span class="lbl"></span>
	                            </label>
	                        </td>
				            <td><?php echo ($vo["accountid"]); ?></td>
				            <td class="center"><span><?php echo ($status_list[$vo['status']]); ?></span></td>
				            <td class="center"><?php echo ($accountTypeList[$vo['accounttype']]); ?></td>
				            <td class="center"><span><?php echo ($vo["inserttime"]); ?></span></td>
                ...
                <div class="col-sm-4">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <?php if(is_array($statusCcList)): $i = 0; $__LIST__ = $statusCcList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                    <a href="<?php echo U('changeStatus',array('method'=>$key));?>" class="ajax-post" target-form="ids"><?php echo ($vo); ?></a>
                                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                </div>
