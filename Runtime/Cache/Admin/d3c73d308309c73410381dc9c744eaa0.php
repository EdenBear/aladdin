	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="text" class="width-100 input-large" name="name" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="text" class="width-100 input-large" name="title" value="<?php echo ((isset($info["title"]) && ($info["title"] !== ""))?($info["title"]):''); ?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="text" class="width-100 input-small" name="sort" value="<?php echo ((isset($info["sort"]) && ($info["sort"] !== ""))?($info["sort"]):0); ?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<textarea name="value" class="autosize-transition span12 form-control" cols="40"><?php echo ((isset($info["value"]) && ($info["value"] !== ""))?($info["value"]):''); ?></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-12 col-sm-2 control-label no-padding-right">配置项</label>
			<div class="col-xs-12 col-sm-5">
				<textarea name="extra" class="autosize-transition span12 form-control" cols="40"><?php echo ((isset($info["extra"]) && ($info["extra"] !== ""))?($info["extra"]):''); ?></textarea>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<textarea name="remark" class="autosize-transition span12 form-control" rows="" cols="40"><?php echo ((isset($info["remark"]) && ($info["remark"] !== ""))?($info["remark"]):''); ?></textarea>
			</div>
