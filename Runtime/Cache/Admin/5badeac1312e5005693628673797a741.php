            ...
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?=U('ztglobject/yzbindex')?>" method="POST" class="search-form">
                        ...
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" id="search-btn" url="<?php echo U('cgqdgl/qdjgindex');?>">
            ...
            <table class="table table-striped table-bordered table-hover dataTable">
			    ...
			    <tbody>
					<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><a data-rel="tooltip" data-placement="bottom" title="查看采购详情" href="<?php echo U('cgxqindex',['purchase_no'=>$vo['purchase_no'],'active'=>'b']);?>"><?php echo ($vo["purchase_no"]); ?></a></td>
                        <td><?=$vo['purchase_name']?></td>
                        <td>
                            <a data-rel="tooltip" data-placement="bottom" title="查看抢单详情" href="<?php echo U('viewqdjg?id='.$vo['bid']);?>">
                                <?=$vo['nick_name']?>
                            </a>
                        </td>
						...
						<td><?php echo ($vo["toubiao_time"]); ?></td>
