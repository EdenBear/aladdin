	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="text" class="width-100" name="title" value="<?php echo ((isset($info["title"]) && ($info["title"] !== ""))?($info["title"]):''); ?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="text" class="width-100" name="url" value="<?php echo ((isset($info["url"]) && ($info["url"] !== ""))?($info["url"]):''); ?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="text" class="width-100" name="sort" value="<?php echo ((isset($info["sort"]) && ($info["sort"] !== ""))?($info["sort"]):'0'); ?>">
			</div>
