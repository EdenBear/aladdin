            ...
            <div class="row">
                <div class="col-sm-12">
                    <form action="" class="search-form">
				        ...
				        <!-- 高级搜索 -->
				        <label> 
                            <input type="text" name="<?php echo ((isset($model['search_key']) && ($model['search_key'] !== ""))?($model['search_key']):'title'); ?>" class="search-input" value="<?php echo I(empty($model['search_key'])?'title':$model['search_key']);?>" placeholder="请输入关键字">
                        </label>
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" id="search-btn" id="search" url="<?php echo U('','model='.$model['name'],false);?>">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <?php if(empty($model["extend"])): ?><label>
                        ...
                        <?php if($model['need_batch_handle']):?>
                            <label>
                                <button class="btn btn-white ajax-post confirm" target-form="ids" url="<?php echo U('del?model='.$model['id']);?>">
                                    删 除
                                </button>
                            </label>
                        <?php endif; endif; ?>
