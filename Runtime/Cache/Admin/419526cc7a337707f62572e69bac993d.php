...
<html lang="cn">
        ...
        <div class="widget-body">
            <div class="">
                <table class="table  table-bordered " style="margin-bottom:0px;">
                    <tbody>
                    <tr>
                        <td><span style="color:#999;padding-right:8px;">用户名:</span><?php echo ($item["real_name"]); ?>(<?php echo ($item["nick_name"]); ?>:<?php echo ($item["mobile_num"]); ?>)</td>
                        <td><span style="color:#999;padding-right:8px;">申请时间:</span><?php echo ($item["insert_time"]); ?></td>
                    </tr>
                    <tr>
                        <td><span style="color:#999;padding-right:8px;">提现金额:</span><?php echo (price_format($item["withdraw_amount"])); ?></td>
                        <td><span style="color:#999;padding-right:8px;">银行账号:</span><?php echo ($item["account_name"]); ?></td>
                    </tr>
                    <tr>
                        <td><span style="color:#999;padding-right:8px;">开户银行:</span><?php echo ($item["bank_name"]); ?></td>
                        <td><span style="color:#999;padding-right:8px;">银行账号:</span><?php echo ($item["account_no"]); ?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
    ...
    <form action="<?php echo U('withdrawcheck');?>" method="POST" class="form-horizontal" id="form_submit" role="form">
        <input type="hidden" value="<?php echo ($item["order_id"]); ?>" name="order_id">
