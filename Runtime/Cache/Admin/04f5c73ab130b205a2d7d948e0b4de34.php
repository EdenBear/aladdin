        ...
        <div class="dataTables_wrapper">  
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form class="search-form">
                        <label>手机号码
                            <input type="text" class="search-input " name="mobilenum" value="<?php echo I('mobilenum');?>" placeholder="请输入手机号码">
                        </label>
                        <label>姓名
                            <input type="text" class="search-input" name="real_name" value="<?php echo I('real_name');?>" placeholder="请输入姓名">
                        </label>
                        <label>申请时间段
                            <input type="text" class="search-input day-input" name="sdate" value="<?php echo I('edate');?>" placeholder="选择开始时间">
                        </label>-
                        <label>
                            <input type="text" class="search-input day-input" name="edate" value="<?php echo I('edate');?>" placeholder="选择结束时间">
                        </label>
                        <label>用户昵称
                            <input type="text" class="search-input " name="nick_name" value="<?php echo I('nick_name');?>" placeholder="请输入用户昵称">
                        </label>
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" id="search" url="<?php echo U('withdraw');?>">
            ...
            <table class="table table-striped table-bordered table-hover dataTable">
				...
				<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($item["real_name"]); ?>(<?php echo ($item["nick_name"]); ?>:<?php echo ($item["mobile_num"]); ?>)</td>
                        <td>
                            <?php echo (price_format($item["withdraw_amount"])); ?>
                        </td>
                        <td><?php echo (price_format($item["commission_fees"])); ?></td>
                        <td><?php echo ($item["insert_time"]); ?></td>
                        <td><?php echo (price_format($item["remaining_sum"])); ?></td>
