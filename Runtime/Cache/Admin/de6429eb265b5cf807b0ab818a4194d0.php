...
<div class="table-responsive">
        <div class="dataTables_wrapper">  
            ...
            <div class="row">
                <div class="col-sm-4">
                    <label>
                        <a class="btn btn-white" href="<?php echo U('addaction');?>">
                            新增
                        </a>
                    </label>
                    <label>
                        <button type="button" class="btn btn-white ajax-post" target-form="ids" url="<?php echo U('setstatus?Model=Action&status=1');?>">
                            启 用
                        </button>
                    </label>
                    <label>
                        <button type="button" class="btn btn-white ajax-post" target-form="ids" url="<?php echo U('setstatus?Model=Action&status=0');?>">
                            暂停
                        </button>
                    </label>
                    <label>
                        <button type="button" class="btn btn-white ajax-post confirm" target-form="ids" url="<?php echo U('setStatus?Model=Action&status=-1');?>">
                            删除
                        </button>
                    </label>
                </div>
