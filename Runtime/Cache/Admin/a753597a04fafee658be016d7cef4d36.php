            ...
            <div class="row">
                <div class="col-sm-12">
                    <form class="search-form">
                        <label>公司简称
                            <input type="text" class="search-input" name="short_name" value="<?php echo I('short_name');?>" placeholder="请输入公司简称">
                        </label>
                        <label>帐户昵称
                            <input type="text" class="search-input" name="nick_name" value="<?php echo I('nick_name');?>" placeholder="请输入账户昵称">
                        </label>
                        <label>
