...
<div class="tabbable">
    ...
    <div class="tab-content no-border padding-24">
        <div class="tab-pane active">
            <?php  echo ace_form_open('user/submitNickname'); $options = array( 'label_text'=>'昵称', 'help'=>'（请输入新昵称）', ); echo ace_input_m($options ,'nickname',get_username()); echo ace_srbtn(); echo ace_form_close() ?>
       </div>
    </div>
</div>
